...
Although I have been helping in forums and the like on and off for a long period of time which you can read a little more about in this post ([Standing upon the shoulders of Giants](todo:http://tenbulls.co.uk/2011/08/01/standing-upon-the-shoulders-of-giants/)) I always felt that I had more to give, more to share, more to say and more to learn. I decided to submit my first ever public presentation to [SQLBits 7](http://sqlbits.com/Sessions/Event7/Thinking_outside_the_Box_Learning_a_little_about_a_lot) and surprisingly managed to secure a speaking slot! As daunting as the whole thing was, I think I managed to pull it off -and if nothing else I know that I learned LOADS during my weeks and weeks of hard graft of preparation putting it all together.
...
You can read more about my exploits at SQLRally [here](todo:https://tenbulls.co.uk/2011/05/25/sqlrally-scalable-shared-database-demo-redux/) and [here](todo:https://tenbulls.co.uk/2011/05/18/the-real-value-of-attending-sqlrally/).
...
- Presented [SQL Server Clustering for Dummies at SQLBits 8](https://sqlbits.com/Sessions/Event8/SQL_Server_Clustering_for_Dummies) at Brighton, UK
- Presented Orders of Magnitude at SQLRally #1 in Orlando, USA
- Presented [READPAST & Furious at SQLBits 9](https://sqlbits.com/Sessions/Event9/READPAST__Furious_Transactions_Locking_and_Isolation) in Liverpool, UK
- Co-Presented [PoSh Clustering at SQLBits 9](https://sqlbits.com/Sessions/event9/POSH_Clustering) in Liverpool, UK
- Presented SQL Server Clustering for Dummies lightning talk at SQLPASS 2011 in Seattle, USA
- Was an Official SQLPASS Blogger for [SQLPASS 2011](http://www.sqlpass.org/summit/2011/) in Seattle, USA. My posts during the event can be found [here](todo:https://tenbulls.co.uk/2011/10/09/im-gonna-be-on-the-bloggers-table/) and [here](todo:https://tenbulls.co.uk/2011/10/12/my-alarm-clock-worked/) and [here](todo:https://tenbulls.co.uk/2011/10/12/community-is-driving-sql-to-success/) and [here](todo:https://tenbulls.co.uk/2011/10/14/nolock-hits-mythbusters/).
- Was a [SQLPASS first timers Big Brother](https://www.sqlpass.org/summit/2011/Connect/FirstTimers.aspx)
...
- Due to present at the [Southampton SQL Server User Group](https://https://sqlserverfaq.com/events/338/Jonathan-Allen-and-Mark-Broadbent-both-presenting.aspx)
- *UPDATE* Due to present at [SQLSaturday #115 Lisbon](https://www.sqlsaturday.com/viewsession.aspx?sat=115&sessionid=7076)
- Due to present at [SQL Saturday #105 Dublin](https://sqlsaturday.com/viewsession.aspx?sat=105&sessionid=6542)
- Due to present at [SQLBits X](https://sqlbits.com/Sessions/Event10/Enter_the_Dragon_SQL_2012_on_Server_Core)
