+++
date = '2012-02-16T21:50:00+01:00'
draft = false
title = '24 Hours Of PASS goes multi-lingual'
categories = ['Personal Development']
tags = ['Public Speaking','24HOP']
+++
...
![I come from Barcelona!](/images/2012/basil-in-the-ratatouille.jpg)<br/>
...
I have just been speaking privately with Rob Farley ([blog](https://sqlblog.com/blogs/rob_farley/)|[twitter](https://twitter.com/#!/rob_farley)) and have found out about the plans for the next iteration of [24 Hours of PASS](https://www.sqlpass.org/24hours/spring2012/). What he has told me is that each session will have Live Closed Captioning in 15 different languages!!! Can you believe that? This means that all the sessions will be accessible to people who speak other languages other than English and makes 24 Hour of PASS a truly international event for the very first time. As Rob put it “if someone in China asks you a question in Chinese… you’ll be able to read it in English and they’ll read your answer in Chinese”.

If you are one of those non-English language SQL professionals that has 'till now not been able to view the English language 24HOP (you are obviously reading this blog using [Google Translate](https://translate.google.com/) 🙂) and want to have access to valuable, technical, up to date material -then come and join the party. And remember my story, please don’t forget to introduce a friend!

To register for all 24 sessions go click [here](https://www.sqlpass.org/24hours/spring2012/SessionsbySchedule.aspx) without delay, and don’t forget to join me for my session *Moves like Jagger – Upgrading to SQL Server 2012*. You should also check out Rob’s post about these excellent changes by clicking [here](https://sqlblog.com/blogs/rob_farley/archive/2012/02/17/24-hours-of-pass.aspx).