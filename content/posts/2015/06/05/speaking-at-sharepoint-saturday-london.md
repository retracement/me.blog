+++
date = '2015-06-05T10:43:00+01:00'
draft = false
title = 'Speaking at SharePoint Saturday London 2015'
categories = ['Personal Development']
tags = ['Community','Public Speaking','SharePoint Saturday']
+++

![Evoconf](/images/2015/evoconf.jpg)

I don't think it is any great secret that I have had my eyes on the SharePoint Community for quite some time. With the introduction of a dedicated SharePoint track (and precon) in 2013 at [SQLSaturday Cambridge](https://sqlcambs.org.uk/category/sqlsaturday/) (a World 1st, I believe) and most recently my attendance of the three day annual [SharePoint Evolution Conference](https://www.sharepointevolutionconference.com/) in London, it has been clear to me for years that the SQL and SharePoint Communities and technologies are more closely related and integrated than I think most professionals would realize. They are simply just different perspectives on what is essentially the end goal of presenting data to the end-user.
...
After a quick chat during the event with Peter Baddeley ([blog](https://baddaz.com/)|[twitter](https://twitter.com/baddaz)) about my intentions to one day submit some sessions to a SharePoint event in the future, his encouragement was such that I decided to do this sooner rather than later and promptly submitted an abstract to SharePoint Saturday London.
...
My session [SharePoint is from Mars, SQL Server is from Venus](https://www.spsevents.org/city/London/London2015/speakers#) was born, and I am delighted that it has been selected. I cannot wait to be part of what I know will be a great event and look forward to seeing you there.