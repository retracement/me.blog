+++
date = '2015-06-25T10:43:00+01:00'
draft = false
title = 'Announcing SharePoint Saturday Cambridge 2015'
categories = ['Personal Development']
tags = ['Community','SharePoint Saturday','SQLSaturday']
+++

In 2013, [SQLSaturday Cambridge](https://www.sqlsaturday.com/228/eventhome.aspx) became the first ever SQLSaturday in the World to host a dedicated SharePoint track and the event was a great success. It struck me at the time how well we managed to get a SharePoint audience at an event that was largely about SQL Server so with the support of our dedicated SharePoint sponsors ([Combined Knowledge](https://www.combined-knowledge.com/), [K2](https://www.k2.com/) and [AxioWorks](https://www.axioworks.com/)), a fantastic addition of SharePoint speakers and with the expert help from the SharePoint community through Peter Baddeley ([web](https:https://about.me/baddaz)|[twitter](https://twitter.com/baddaz)) I think we managed to light the touch paper for my future plans for [SQLSaturday Cambridge](https://www.sqlsaturday.com/411/EventHome.aspx).

Since that event I have harbored a desire to continue our innovation with SQLSaturday Cambridge and I am therefore delighted to finally announce that as of yesterday our SharePoint “experiment” that we pioneered in 2013 is now an official reality through our sister event [SharePoint Saturday Cambridge](https://www.spsevents.org/city/cambridge/cambridge2015). A further [call for speakers](https://www.spsevents.org/city/Cambridge/Cambridge2015/speakers) is open for SharePoint Saturday Cambridge and this will close no later than July 31st.
