+++
date = '2014-04-07T13:32:00+01:00'
draft = false
title = 'Inside SQLSaturday: Lisbon'
categories = ['Personal Development']
tags = ['Community','SQLSaturday']
+++
...
>**Mark:** Hello Niko! Thank you for agreeing to talk to me for my Inside SQLSaturday Series. I know you are really busy right now! It feels like an eternity since we have spoken properly, so tell me what have you been up to over the last 6 months?

>**Niko:** After moving from my previous position as PASS Community Evangelist I am now working together with my colleagues Tillmann Eitelberg ([web](https://ssis-components.net/)|[twitter](https://twitter.com/_Tillmann)) & Oliver Engels ([web](https://ssis-components.net/)|[twitter](https://twitter.com/oengels)) at [OH22 Information Services](https://www.oh22.is) and we are working on a range of different and exciting projects.
>From the community perspective, we are running new events in the Northern Portugal – Oporto with a lot of success. The last meeting we held had 35 attendees. Of course we are still running regular [SQLPort](https://www.sqlport.com) meetings every month in Lisbon.

---

>**Mark:** With the start of SQLSaturday Lisbon just around the corner (pre cons are due this Thursday and Friday, the community day is this Saturday), I think it should not be forgotten that this event is famous for being the first ever [SQLSaturday](https://www.sqlsaturday.com/) outside of the US. That must make you and your team very proud, tell me how all this came about?

>**Niko:** I honestly do not feel proud, I feel more like I was truly lucky.
...
>With this goal I went to the [PASS Summit](https://www.sqlpass.org/summit/) and after all the conversations that I have held with SQLSaturday creator Andy Warren ([web](https://sqlandy.com/)|[twitter](https://twitter.com/sqlandy)), in just 3 days he promised to give me an opportunity to organize one.
...
>The rest is just history – we got support from our local Microsoft office and the next April (2011) we held our first event. PASS also sent us an internationally recognised speaker ([Scott Stauffer](https://twitter.com/SQLSocialite)), and with support of [Microsoft Portugal](https://www.microsoft.com/pt-pt/default.aspx) we managed to get [Ramesh Meyappan](https://www.sqlworkshops.com/about) as well. We had an amazing event (from a newbie point of view) and on the Friday (yes we were asked to do it during the week in order to lower the risk!) we had around 109 people.

---

>**Mark:** Did you feel any resistance to holding the event and if so from where and how did you overcome those challenges?

>**Niko:** Absolutely. First of all – people are afraid of changes, any changes.
...
>**Mark:** Having a mix of English language and Portuguese language speakers on the agenda, it must be very difficult to decide the balance of sessions. I have heard of other European events having these discussions and wonder how much consideration goes into choosing a session based on the language of delivery? What are the challenges you face?

>**Niko:** This year our event will be 100% done in English, especially since we have attendees signed up from 12 different countries. We aim to do our best to complete our vision of what we are trying to achieve, we select sessions which are running into the direction that we are moving in.
...
>**Mark:** I think more than any other event, the hospitality and welcome you guys show to travelling speakers is second to none and a benchmark for all SQLSaturdays and IT events around the world. Tell me, is this an intentional thing or just a cultural Portuguese trait?

>**Niko:** You are doing amazing job yourself as well, mate!
...
>**Thursday 10th April**
>
>Tim Mitchell – Real World SSIS: Survival Guide ([web](https://www.solidq.com/author/Tim_Mitchell/)|[twitter](https://twitter.com/Tim_Mitchell)).
>
>Milos Radivojevic – SQL Server for Application Developers (web|[twitter](https://twitter.com/MilosSQL)).
>
>Edwin Sarmiento – High Availability & Disaster Recovery Deep Dive ([web](https://bassplayerdoc.wordpress.com/)|[twitter](https://twitter.com/EdwinMSarmiento)).
>
>**Friday 11th April**
>
>Paul Turley – Complete BI Solution with Office & SQL Server ([web](https://sqlserverbiblog.wordpress.com/)|[twitter](https://twitter.com/paul_turley)).
>
>Brent Ozar – Virtualization, Storage, and Hardware for SQL Server ([web](https://www.brentozar.com/)|[twitter](https://twitter.com/brento)).
>
>For more detail, please visit [here](https://www.sqlport.com/sql-server/noticias/07-01-2014/sqlsaturday-lisboa-portugal-2014).
...
>**Mark:** Last year on the Sunday after the event you took the speakers on a rather fabulous trip to a Castle (Sintra) on a very high hillside. Have you anything similar surprises planned this year?
...
>**Mark:** And if you had to recommend that a person learns only two languages fluently, which would you choose and why?

>**Niko:** English – is the most important language right now.
...
![Microsoft Lisbon](/images/2014/lisbonexp.jpg)

SQLSaturday Lisbon is due to commence this week, starting with the Pre-conference sessions this Thursday 10th and Friday 11th April and you can book one of these fabulous sessions by visiting [here](https://www.sqlport.com/sql-server/noticias/07-01-2014/sqlsaturday-lisboa-portugal-2014).

The Community day is being held on the Saturday 12th April and if you are lucky you can grab a registration by visiting [here](https://www.sqlsaturday.com/267/register.aspx).
