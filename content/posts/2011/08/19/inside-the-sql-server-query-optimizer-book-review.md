+++
date = '2011-08-19T14:02:00+01:00'
draft = false
title = 'Review of Inside the SQL Server Query Optimizer'
categories = ['Personal Development']
tags = ['SQL','Books']
+++

[![Inside the SQL Server Query Optimizer](/images/2011/insidequerysmall.jpg)](https://www.amazon.com/Inside-SQL-Server-Query-Optimizer/dp/1906434603)

There are only a handful of people that when they talk about something you should sit up and take notice, and for me Benjamin Nevarez ([blog](https://www.benjaminnevarez.com/)|[twitter](http://twitter.com/#!/BenjaminNevarez)) is one of those. As someone I’ve been following technically for several years, when I saw that his book [Inside the SQL Server Query Optimizer](https://www.amazon.com/Inside-SQL-Server-Query-Optimizer/dp/1906434603) had been released to the Kindle format, I immediately clicked the purchase button and I haven’t been disappointed.
...
![Query Onion](/images/2011/query-onion.jpg)<br/>
*This is not a loop join!*
