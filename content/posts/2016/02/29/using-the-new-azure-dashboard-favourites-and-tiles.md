+++
date = '2016-02-29T14:57:00+01:00'
draft = false
title = 'Using the new Azure Dashboard favourites and tiles'
...
![Favourites sidebar](/images/2016/sidebar.png)<br/>
...
![storage0-tb](/images/2016/storage0-tb.png)
...
Once you have customized your menu to your satisfaction it is worth minimizing the favourites list by clicking on the <img src="/images/2016/minimize1.webp" alt="minimize" /> button just beneath the Microsoft Azure logo. This will hide (or display) the favourite titles leaving only the icons on your screen real estate.
...
![tiles](/images/2016/tiles1.png)

In order to drag a tile somewhere else within the dashboard surface area you can either switch the dashboard into edit mode by clicking <img src="/images/2016/edit.webp" alt="edit"/> on the Portal Menu ribbon, or hover the mouse pointer over the tile you wish to move until its menu bar appears. Simply drag the tile to the position you desire (other tiles will automatically adjust their position to accommodate). You will probably get better mileage from laying the tiles to fit either a vertical or horizontal layout if you commonly use different screen orientations.

![select tile](/images/2016/tile_select1.png)
...
![microsoft azure](/images/2016/microsoftazure.png)
