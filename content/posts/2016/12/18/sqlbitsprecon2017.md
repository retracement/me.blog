+++
date = '2016-12-18T18:07:00+01:00'
draft = false
title = 'Announcing my SQLBits 2017 Pre-conference Session'
categories = ['Personal Development']
tags = ['Public Speaking','SQLBits']
+++
...
![Creeper](/images/2016/creeper1.png)<br/>
...
If any of these are true then have no fear, for in this demo-rich pre-conference I will explain how you can build your own “High Availability” environment in the safety of your own laptop<sub>*1</sub>, home network or work test network.
...
*<sub>*1</sub> Please note that deployment on a single host is for testing purposes only (in case that wasn’t obvious!)*
...
**Please note that the SQLBits Preconference sessions are not yet available for booking, these will be made available in the New Year**